...
const RecordsSection = memo(() => {
  ...
  }, [tempFilterProvince, tempFilterCity, tempFilterFirm, tempFilterTeam, getFavoriteLists]);
  ...
  }, [page, sortBy, sortDir, filterProvince, filterCity, filterFirm, filterTeam, filterFavorites, getFavoriteLists]);
    ...
    <Box sx={{ mb: 8 }}>
     ...
     {selectedRow && (
       ...
       >
         ...
         >
           <Typography variant="h5" sx={{ fontWeight: 700 }}>Advisor Details</Typography>
         </DialogTitle>
         ...
         <DialogContent sx={{ 
           ...
           <Box sx={{ p: 4, borderBottom: '1px solid rgba(0,0,0,0.05)', backgroundColor: 'white' }}>
             ...
             <Grid container spacing={3}>
               ...
               <Grid item xs={12} md={6}>
                 <Paper elevation={0} sx={{ 
                   ...
                   <Box sx={{ mb: 3 }}>
                     <Typography variant="body2" color="textSecondary" sx={{ mb: 0.5, fontWeight: 600 }}>Team Name</Typography>
                     <Typography variant="body1" sx={{ fontWeight: selectedRow['Team Name'] ? 500 : 400 }}>
                       {selectedRow['Team Name'] || 'N/A'}
                     </Typography>
                   </Box>
                   
                   <Box sx={{ mb: 3 }}>
                     <Typography variant="body2" color="textSecondary" sx={{ mb: 0.5, fontWeight: 600 }}>Firm</Typography>
                   ...
                   <Box sx={{ mb: 3 }}>
                     <Typography variant="body2" color="textSecondary" sx={{ mb: 0.5, fontWeight: 600 }}>Branch</Typography>
                   ...
                   <Box sx={{ mb: 1 }}>
                     <Typography variant="body2" color="textSecondary" sx={{ mb: 0.5, fontWeight: 600 }}>Title</Typography>
                     <Typography variant="body1" sx={{ fontWeight: 500 }}>
               ...
               <Grid item xs={12} md={6}>
                 <Paper elevation={0} sx={{ 
                   ...
                   <Box sx={{ mb: 3 }}>
                     <Typography variant="body2" color="textSecondary" sx={{ mb: 0.5, fontWeight: 600 }}>Address</Typography>
                     <Typography variant="body1">
                   ...
                   <Box sx={{ mb: 1 }}>
                     <Typography variant="body2" color="textSecondary" sx={{ mb: 0.5, fontWeight: 600 }}>Email</Typography>
                     {selectedRow['Email'] ? (
                       <Button 
                         startIcon={<EmailIcon />}
